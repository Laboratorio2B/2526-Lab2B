...
@; rispetto al codice in quicksort.s in questa versione si 
@; usano r2 e r3 come puntatori al'intero dell'array r0
#; invece di usarle come gli indici i,j del partition in C 


            .data
            .text
            .global qs_arm @; 
            .type qs_arm, %function @; dice all'assembler che qs_arm è una funzione  
...
qs_arm:     cmp r1,#1
            ...
            @; abbiamo che r1 > 1 procediamo con il partizionamento
            push {r4,r5,lr}         @; salvo i registri
            sub r2,r0,#4            @;  = &a[-1]
