...
primo:  cmp r0, #2     @; calcola r0-2
        ...
        bne not2       @; se r0!=2 continua     
        mov pc, lr     @; altrimenti return 2
not2:   and r1, r0, #1 @; r1 = r0 & 1 = r0%2
        cmp r1, #0     @; r0 e' pari?
        bne odd        @; se r0 e' dispari continua
nonpr:  mov r0, #0     
...
loop:   mul r3,r1,r1
        ...
        mov r3,r0
resto1: cmp r3,r1
        blo resto2     @; se r3<r1 r3 è il resto
        sub r3,r3,r1
        b resto1
...
stop:   ldr r0,=errmsg
        ...
        mov r0,#33      @; non salvo lr prima di perror perché exit non ritorna 
        b exit          @; exit(33)
