...
# comando per importare i moduli e accedere
# alle funzioni/variabili al loro interno
# vedere uso sys.argv alla fine del file
import sys

# esempi fatti a lezione: per sperimentare scrivere
#    python -i PvvsC.py
...
# esempio for-each sugli elementi di una lista
...
# ... per analogia con il C spesso la usiamo 
