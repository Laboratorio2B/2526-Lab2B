...
public class Citta {
  ...
  public static void main(String[] args) {
    ...
    // il programma, stampo un messaggio e elaboro le città lette
      ...
      System.err.println(e + "\nRiga incompleta: interrompo la lettura ");
    }
    catch(Exception e) {
    ...
    ArrayList<Citta> lista = new ArrayList<Citta>(insieme);
    lista.sort((c1,c2) -> c1.popolazione - c2.popolazione); 
    System.out.println("Elenco ordinato per popolazione crescente:");    
    for(Citta c: lista)
      System.out.println(c);
    System.out.println("---- end ----");
  }
